...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        other1.elements[1] * other2.elements[1] + other1.elements[2] * other2.elements[2]; 
    ...
    static cross(other1, other2) {
        ...
        let v3 = (other1.elements[1] * other2.elements[0])- (other1.elements[0] * other2.elements[1]);
    ...
    normalize() {
        // Insert your code here.
        // This function should change this vector (this.elements) and not create a new vector.
        this.elements[0] = this.elements[0] / Math.sqrt(this.elements[0]**2 + this.elements[1]**2);
        this.elements[1] = this.elements[1] / Math.sqrt(this.elements[0]**2 + this.elements[1]**2);
        // Don't delete the return statement.
        return this;
    };
}
